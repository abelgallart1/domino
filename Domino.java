  ...
  static public ArrayList fichastodas=new ArrayList();
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        panelJugador2.add(f);
         ...
         j2=new JugadorVirtualGorda(fichas2);
         n=new Nombre(null,true);
         n.setLocationRelativeTo(null);
         n.setVisible(true); 
         j2.nombre=n.nombre.getText()+n.nombre.getText().hashCode();
        ...
        panelJugador3.add(f);
         ...
         j3=new JugadorVirtualGorda(fichas3);
         n=new Nombre(null,true);
         n.setLocationRelativeTo(null);
         n.setVisible(true); 
         j3.nombre=n.nombre.getText()+n.nombre.getText().hashCode();
        ...
        panelJugador4.add(f);
         ...
         j4=new JugadorVirtualGorda(fichas4);
         n=new Nombre(null,true);
         n.setLocationRelativeTo(null);
         n.setVisible(true); 
         j4.nombre=n.nombre.getText()+n.nombre.getText().hashCode();
   ...
   if(f!=null){
     ...
     if (cursor.e1==f.punta){
                             ...
                             if (X1>220&&b1==0){ 
                                ...
                                (null,"Seleccion incorrecta","Forro",javax.swing.JOptionPane.OK_OPTION);      
